...
const Navbar = () => {
  ...
  return (
    <>
      <nav ref={navRef} className='fixed z-50 flex flex-col justify-between w-fit h-full px-10 capitalize bg-black text-white/80 py-28 gap-y-10 md:w-1/2 md:left-1/2 lg:rounded-bl-2xl lg:rounded-tl-2xl'>

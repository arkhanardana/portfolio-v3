...
const About = () => {
  ...
  return (
    <section id="about" className="min-h-screen bg-[#e5e5e0] lg:mt-40 mt-10 scroll-mt-10">
      ...
      <div className="flex flex-col items-center justify-between gap-16 px-10 text-xl font-light tracking-wide lg:flex-row md:text-2xl lg:text-3xl text-white/60">
        <Image
          ...
          width={500}
          height={500}
          className="w-md rounded-3xl grayscale hover:grayscale-0 transition-all duration-300"
        />
